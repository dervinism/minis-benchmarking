...
for iTest = 1:numel(testType)
  ...
  % Mini Analysis
  if strcmpi(testType{iTest}, 'test1')
    folder{1} =  fullfile(dataRepo,recFolder,'p103a','mat_MA');
    folder{2} =  fullfile(dataRepo,recFolder,'p106b','mat_MA');
    folder{3} =  fullfile(dataRepo,recFolder,'p108a','mat_MA');
    folder{4} =  fullfile(dataRepo,recFolder,'p108b','mat_MA');
    folder{5} =  fullfile(dataRepo,recFolder,'p108c','mat_MA');
    folder{6} =  fullfile(dataRepo,recFolder,'p120b','mat_MA');
    folder{7} =  fullfile(dataRepo,recFolder,'p122a','mat_MA');
    folder{8} =  fullfile(dataRepo,recFolder,'p124b','mat_MA');
    folder{9} =  fullfile(dataRepo,recFolder,'p125a','mat_MA');
    folder{10} = fullfile(dataRepo,recFolder,'p127c','mat_MA');
    folder{11} = fullfile(dataRepo,recFolder,'p128c','mat_MA');
    folder{12} = fullfile(dataRepo,recFolder,'p129a','mat_MA');
    folder{13} = fullfile(dataRepo,recFolder,'p131a','mat_MA');
    folder{14} = fullfile(dataRepo,recFolder,'p131c','mat_MA');
    targetDir = performanceTestDir1;
  elseif strcmpi(testType{iTest}, 'testSelect')
    folder{1} =  fullfile(dataRepo,recFolder,'p103a','mat_MA_select');
    folder{2} =  fullfile(dataRepo,recFolder,'p106b','mat_MA_select');
    folder{3} =  fullfile(dataRepo,recFolder,'p108a','mat_MA_select');
    folder{4} =  fullfile(dataRepo,recFolder,'p108b','mat_MA_select');
    folder{5} =  fullfile(dataRepo,recFolder,'p108c','mat_MA_select');
    folder{6} =  fullfile(dataRepo,recFolder,'p120b','mat_MA_select');
    folder{7} =  fullfile(dataRepo,recFolder,'p122a','mat_MA_select');
    folder{8} =  fullfile(dataRepo,recFolder,'p124b','mat_MA_select');
    folder{9} =  fullfile(dataRepo,recFolder,'p125a','mat_MA_select');
    folder{10} = fullfile(dataRepo,recFolder,'p127c','mat_MA_select');
    folder{11} = fullfile(dataRepo,recFolder,'p128c','mat_MA_select');
    folder{12} = fullfile(dataRepo,recFolder,'p129a','mat_MA_select');
    folder{13} = fullfile(dataRepo,recFolder,'p131a','mat_MA_select');
    folder{14} = fullfile(dataRepo,recFolder,'p131c','mat_MA_select');
    targetDir = performanceTestDirSelect;
  elseif strcmpi(testType{iTest}, 'test2')
    folder{1} =  fullfile(dataRepo,recFolder,'p103a','mat_MA2');
    folder{2} =  fullfile(dataRepo,recFolder,'p106b','mat_MA2');
    folder{3} =  fullfile(dataRepo,recFolder,'p108a','mat_MA2');
    folder{4} =  fullfile(dataRepo,recFolder,'p108b','mat_MA2');
    folder{5} =  fullfile(dataRepo,recFolder,'p108c','mat_MA2');
    folder{6} =  fullfile(dataRepo,recFolder,'p120b','mat_MA2');
    folder{7} =  fullfile(dataRepo,recFolder,'p122a','mat_MA2');
    folder{8} =  fullfile(dataRepo,recFolder,'p124b','mat_MA2');
    folder{9} =  fullfile(dataRepo,recFolder,'p125a','mat_MA2');
    folder{10} = fullfile(dataRepo,recFolder,'p127c','mat_MA2');
    folder{11} = fullfile(dataRepo,recFolder,'p128c','mat_MA2');
    folder{12} = fullfile(dataRepo,recFolder,'p129a','mat_MA2');
    folder{13} = fullfile(dataRepo,recFolder,'p131a','mat_MA2');
    folder{14} = fullfile(dataRepo,recFolder,'p131c','mat_MA2');
    targetDir = performanceTestDir2;
  end
  ...
  % pClamp_raw
  if strcmpi(testType{iTest}, 'test1')
    folder{1} =  fullfile(dataRepo,recFolder,'p103a','mat_pC_raw');
    folder{2} =  fullfile(dataRepo,recFolder,'p106b','mat_pC_raw');
    folder{3} =  fullfile(dataRepo,recFolder,'p108a','mat_pC_raw');
    folder{4} =  fullfile(dataRepo,recFolder,'p108b','mat_pC_raw');
    folder{5} =  fullfile(dataRepo,recFolder,'p108c','mat_pC_raw');
    folder{6} =  fullfile(dataRepo,recFolder,'p120b','mat_pC_raw');
    folder{7} =  fullfile(dataRepo,recFolder,'p122a','mat_pC_raw');
    folder{8} =  fullfile(dataRepo,recFolder,'p124b','mat_pC_raw');
    folder{9} =  fullfile(dataRepo,recFolder,'p125a','mat_pC_raw');
    folder{10} = fullfile(dataRepo,recFolder,'p127c','mat_pC_raw');
    folder{11} = fullfile(dataRepo,recFolder,'p128c','mat_pC_raw');
    folder{12} = fullfile(dataRepo,recFolder,'p129a','mat_pC_raw');
    folder{13} = fullfile(dataRepo,recFolder,'p131a','mat_pC_raw');
    folder{14} = fullfile(dataRepo,recFolder,'p131c','mat_pC_raw');
    targetDir = performanceTestDir1;
  elseif strcmpi(testType{iTest}, 'testSelect')
    folder{1} =  fullfile(dataRepo,recFolder,'p103a','mat_pC_raw_select');
    folder{2} =  fullfile(dataRepo,recFolder,'p106b','mat_pC_raw_select');
    folder{3} =  fullfile(dataRepo,recFolder,'p108a','mat_pC_raw_select');
    folder{4} =  fullfile(dataRepo,recFolder,'p108b','mat_pC_raw_select');
    folder{5} =  fullfile(dataRepo,recFolder,'p108c','mat_pC_raw_select');
    folder{6} =  fullfile(dataRepo,recFolder,'p120b','mat_pC_raw_select');
    folder{7} =  fullfile(dataRepo,recFolder,'p122a','mat_pC_raw_select');
    folder{8} =  fullfile(dataRepo,recFolder,'p124b','mat_pC_raw_select');
    folder{9} =  fullfile(dataRepo,recFolder,'p125a','mat_pC_raw_select');
    folder{10} = fullfile(dataRepo,recFolder,'p127c','mat_pC_raw_select');
    folder{11} = fullfile(dataRepo,recFolder,'p128c','mat_pC_raw_select');
    folder{12} = fullfile(dataRepo,recFolder,'p129a','mat_pC_raw_select');
    folder{13} = fullfile(dataRepo,recFolder,'p131a','mat_pC_raw_select');
    folder{14} = fullfile(dataRepo,recFolder,'p131c','mat_pC_raw_select');
    targetDir = performanceTestDirSelect;
  elseif strcmpi(testType{iTest}, 'test2')
    folder{1} =  fullfile(dataRepo,recFolder,'p103a','mat_pC_raw2');
    folder{2} =  fullfile(dataRepo,recFolder,'p106b','mat_pC_raw2');
    folder{3} =  fullfile(dataRepo,recFolder,'p108a','mat_pC_raw2');
    folder{4} =  fullfile(dataRepo,recFolder,'p108b','mat_pC_raw2');
    folder{5} =  fullfile(dataRepo,recFolder,'p108c','mat_pC_raw2');
    folder{6} =  fullfile(dataRepo,recFolder,'p120b','mat_pC_raw2');
    folder{7} =  fullfile(dataRepo,recFolder,'p122a','mat_pC_raw2');
    folder{8} =  fullfile(dataRepo,recFolder,'p124b','mat_pC_raw2');
    folder{9} =  fullfile(dataRepo,recFolder,'p125a','mat_pC_raw2');
    folder{10} = fullfile(dataRepo,recFolder,'p127c','mat_pC_raw2');
    folder{11} = fullfile(dataRepo,recFolder,'p128c','mat_pC_raw2');
    folder{12} = fullfile(dataRepo,recFolder,'p129a','mat_pC_raw2');
    folder{13} = fullfile(dataRepo,recFolder,'p131a','mat_pC_raw2');
    folder{14} = fullfile(dataRepo,recFolder,'p131c','mat_pC_raw2');
    targetDir = performanceTestDir2;
  end
